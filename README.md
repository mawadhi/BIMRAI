...
Files used for creating the parametric-BIM training dataset can be found [here](https://github.com/mawadhi/BIMrAI/tree/main/bimgene). These include the generated FBX files (from BIMGenE) and the HDRI images used for rendering. The same files were rendered in a 3D graphics software to create the training data that eventually produced the [results](https://github.com/mawadhi/BIMrAI/tree/main/results) of this project. 
